        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map((day) => (
            <button
              ...
              className={`px-3 py-2 rounded text-sm sm:text-base sm:px-4 sm:py-2 ${daysOff.includes(day) ? 'bg-red-500 text-white' : 'bg-white text-black border border-gray-300 hover:bg-red-100'
                } transition-colors`}
            >
              {day}
            </button>
